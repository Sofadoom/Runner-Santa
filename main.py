...
# fly
fly_flame_1 = pygame.image.load('Fly1.png').convert_alpha()
fly_flame_2 = pygame.image.load('Fly2.png').convert_alpha()
fly_frames = [fly_flame_1,fly_flame_2]
fly_frame_index = 0
...
game_name = test_font.render('Runner Santa', False, (0, 163, 108))
game_name_rect = game_name.get_rect(center=(400,80))

game_message = test_font.render('Press Space To Run', False, (0, 163, 108))
    ...
    for event in pygame.event.get():
        ...
        if game_active:
            if event.type == obstacle_timer:
                obstacle_group.add(Obstacle(choice(['fly', 'snil', 'snail', 'snail'])))
